...
Dois projetos com comandos equivalentes de dataset, treino, avaliação, predição e inspeção: [PolyGabor](polygarbor/README.md), baseado em descritores de textura/cor e subespaços polinomiais, e [CNN](cnn/README.md), com ResNet-18 e YOLO11n convertidas do notebook.
